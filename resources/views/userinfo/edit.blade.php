                    ...
                    <form method="POST" action="{{route('userinfo.update', ['id' => $userinfo->id])}}">
                      @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="radio" name="money" value="0" class="mt-3" @if($userinfo->money === 0) checked @endif>はい</input>
                                <input type="radio" name="money" value="1" class="mt-3" @if($userinfo->money === 1) checked @endif>いいえ</input>
                                </div>
                        </div>
